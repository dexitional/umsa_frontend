...
function SchemeCardItem({ data }: Props) {
  return (
    ...
    <div className="w-full flex items-center justify-between space-x-2">
      <div className="flex items-center space-x-2">
          ...
          <div className="py-0.5 px-2 w-fit text-xs rounded bg-primary/60 text-white font-bold">{data.passMark}%</div>
      </div>
    </div>
