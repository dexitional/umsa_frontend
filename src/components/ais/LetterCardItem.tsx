  ...
  return (
    ...
    <div className="w-full flex items-center justify-between space-x-2">
      <div className="flex items-center space-x-2">
          ...
          <div className="py-0.5 px-2 w-fit text-xs rounded bg-primary/60 text-white font-bold">{data?.tag?.toUpperCase()}</div>
      </div>
    </div>
    <div className="w-full space-y-1 font-roboto">
        ...
        <div className="px-4 flex items-center space-x-2">
            <div className="h-14 w-14"><PiSignatureBold className="h-12 w-12 text-primary/70" /></div>
