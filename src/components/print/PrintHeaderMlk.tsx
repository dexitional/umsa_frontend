...
function PrintHeaderMlk({}: Props) {
  return (
    <div className="hidden print:flex md:flex flex-col">
        <span className="m-0 p-0 text-[2.5rem] print:text-[2rem] text-primary font-[san-serif] font-semibold  md:leading-[4rem] text-center">MARTIN LUTHER HEALTH TRAINING  COLLEGE </span>
