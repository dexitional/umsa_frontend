...
import AISBacklogRecordCard from '../../components/ais/AISBacklogRecordCard';
...
function PgAISBacklogRecord({}: Props) {
  ...
  return (
    <div className="flex w-full flex-1 flex-col items-center justify-center space-y-8 md:space-y-8 ">
       <div className="flex w-full flex-1 flex-col space-y-8 md:space-y-10 ">
          { data.meta?.length ? <AISBacklogRecordCard title={ `Records`} data={data} /> : null }
          { !data.meta.length ? (
...
export default PgAISBacklogRecord