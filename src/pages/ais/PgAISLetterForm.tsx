               ...
               <div className="md:pl-6 space-y-4">
                  ...
                  <label className="flex flex-col space-y-2">
                      <div className="flex items-center justify-between">
                        ...
                        <div className="px-2 py-0.5 w-fit text-xs text-white bg-primary cursor-pointer" onClick={() => setShowEditor(!showEditor)}>Toggle View</div>
                      </div>
                      { showEditor 
                        ? <>
                        ...
                        : <textarea name="signatory" ref={signRef} defaultValue={data?.signatory}  className="focus:ring-0 border focus:border-slate-300 border-primary-dark/10 bg-white/5 text-sm md:text-base text-gray-500 rounded-md" />
                      }
                  </label>
                  ...
                  <label className="flex flex-col space-y-2">
                      ...
                      { showEditor 
                        ...
                        : <textarea name="template" ref={tempRef} defaultValue={data?.template} rows={10} className="focus:ring-0 border focus:border-slate-300 border-primary-dark/10 bg-white/5 text-sm md:text-base text-gray-500 rounded-md" />
                      }
                  </label>

                  <label className="flex flex-col space-y-2">
                      <span className="text-sm md:text-base text-gray-500 font-medium">CC:</span>
                      <textarea arial-label="cc" name="cc" defaultValue={data?.cc} className="focus:ring-0 border focus:border-slate-300  border-primary-dark/10 bg-primary-dark/5 text-sm md:text-base text-gray-500 rounded-md" />
                  </label>
